...
const OrderHistories = ({}) => {
    ...
    return (
        <div className="w-full grow-0 overflow-visible p-4">
            <div className="flex flex-col w-full">
                <div className="text-xl lg:pl-8 font-semibold w-full">Trade Order</div>
                {histories.length > 0 ? (
                    <div className="overflow-x-scroll scrollbar-hide">
                        <table className="table-auto mt-2 mb-2 w-full">
                            <thead>
                    ...
                    <div className="text-sm text-center lg:pl-8 border-b border-gray-500 text-gray-300 font-medium">
                        No Trade History...
                    </div>
                )}
            </div>
