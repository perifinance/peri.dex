                ...
                <div className="mb-4">
                    <div className="relative text-center mb-4 ml-4">
                        <button
                            ...
                            onClick={() => setIsNetworkList(false)}
                        >
                            <img src="images/icon/left_arrow.svg"></img>
                        </button>
                        <div className="text-lg">Select a network</div>
                    </div>
                            ...
                            return (
                                <div
                                    ...
                                    className={`flex justify-start cursor-pointer text-gray-200 hover:bg-black-900 rounded-md px-2 py-2 my-2 ${
                                        network?.id === selectedNetwork?.id && "bg-black-900"
                                    }`}
                                    onClick={() => {
                                ...
                                >
                                    <div className="grow text-base px-2">{network.name}</div>
