                        ...
                        {Object.keys(statusMsg).map((state) => (
                            <li className="pb-1" key={state}>
                                <div className="relative flex items-center  my-4 bg-gray-700">
                                    <div className={`items-center inline-flex rounded-full 
                                    ...
                                    {step.toString() >= state && <div className="w-4 h-4 relative inline-flex rounded-full text-cyan-400 bg-cyan-500 z-5">
                                    {/*  <svg
                                            width="16"
                                            height="16"
                                            viewBox="0 0 16 16"
