...
const Bridge = () => {
    ...
    return (
        <div className="flex justify-self-center items-center lg:space-x-4">
            {/* max-w-sm */}
            <div className="hidden self-center my-2 min-w-80 h-[512px] w-80 lg:block bg-blue-900 rounded-l-lg lg:rounded-lg ">
            ...
            <div className="flex flex-col w-full">
                <div className="flex font-medium text-lg">
                    <div className="w-full pt-3 px-9 font-semibold text-center lg:text-left rounded-t-lg bg-blue-900">
                        Bridge
                    </div>
                </div>
                {<Submit></Submit> }
