...
const Trades = ({ children, histories }: TradesProps) => {
    ...
    const filterHistory = (keyward) => {
        ...
        const uniqFiltered = filtered.filter(
    ...
    return (
        <div className="flex flex-col mt-0 w-[98%] lg:w-full h-full rounded-lg my-2 justify-center items-center bg-gradient-to-tl from-cyan-950 via-blue-950 to-cyan-950 ">
            <div className="flex flex-col w-full xs:w-[98.5%] h-[98.5%] rounded-lg items-center">
                <div className="flex justify-start items-center w-full xs:w-[98%] h-10">
                    <div className="text-base sm:text-base font-semibold w-full lg:w-[20%] lg:mt-6 text-center">
                        Trade Order
                    </div>
                </div>
                    ...
                    <div className="flex items-center w-[65%]">
                        ...
                        <div className="relative w-full ">
                            ...
                            <input
                                ...
                                className="border text-[11px] md:text-sm rounded-l-lg block w-full ps-10 p-1.5 focus:outline-none focus:border-gray-600 bg-blue-850 border-gray-500 placeholder-gray-400 "
                                placeholder="Search Date, Chain, Pynth"
                            />
                        </div>
                        <button
                            type="submit"
                            className="p-[6.5px] md:p-[9px] text-sm font-medium rounded-r-lg border border-blue-850 bg-blue-850 hover:bg-blue-700"
                ...
                <div className="flex flex-col justify-between relative w-full ss:w-[98%] h-fit max-h-full overflow-x-scroll scrollbar-hide lg:my-4">
                    <table className="table-auto mt-2 mb-2 ss:w-full h-[90%] min-w-144 border-gray-500">
                        <thead className="border-b border-gray-500 h-8">
                            <tr className="font-medium text-[11px] lg:text-sm text-blue-300">
                                <th className="cursor-pointer select-none" onClick={() => sortHistory("chainId")}>
                                    Chain{getColSort("chainId")}
                                </th>
                                <th className="cursor-pointer select-none" onClick={() => sortHistory("date")}>
                                    Date{getColSort("date")}
                                </th>
                                <th>Time</th>
                                <th className="cursor-pointer select-none" onClick={() => sortHistory("dest")}>
                                    Received{getColSort("dest")}
                                </th>
                                <th>Price</th>
                                <th className="cursor-pointer select-none" onClick={() => sortHistory("src")}>
                                    Paid{getColSort("src")}
                                </th>
                                <th>Fee</th>
